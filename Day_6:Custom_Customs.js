...
//             groupAnswer.includes(letter) ? null : groupAnswer.push(letter)
//         })
//     })
//     result += groupAnswer.length
// })
//console.log(result)  part one 6714
...
data.forEach(item => {
    ...
    item.forEach(str => {
        str.split('').forEach(letter => {
            let count = 0;
            item.forEach(str2 => {
                str2.includes(letter)
                    ? !groupAnswer.includes(letter) ? count++ : null
                    : null
            })
            if (count === item.length) {
                groupAnswer.push(letter)
            }
        })
    })
    result += groupAnswer.length
})
console.log(result)//part two = 3435
